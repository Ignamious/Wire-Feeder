...
knobSize          = [140,1,2];   // The size of each knob [across wheel, along the perimeter, prodruding]
...
shaftDiameter        = 9.5;          // The diameter of the motor shaft
shaftFlatDiameter    = 9.5;
